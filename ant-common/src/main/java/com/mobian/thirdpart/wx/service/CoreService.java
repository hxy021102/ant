...
//		            article.setTitle(hospitalWechatConfig.getWelcomTitle());
//		            article.setDescription(hospitalWechatConfig.getWelcomContent());
//		            article.setPicUrl(hospitalWechatConfig.getWelcomPicUrl());
//		            article.setUrl(hospitalWechatConfig.getWelcomeUrl());

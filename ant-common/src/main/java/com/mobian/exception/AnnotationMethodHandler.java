 ...
 */
@Service
public class AnnotationMethodHandler extends WebContentGenerator {
	...
	public boolean isResponseBody(HttpServletRequest request,Object handler) throws ServletException{
		ServletHandlerMethodResolver methodResolver = getMethodResolver(handler);
		Method handlerMethod = methodResolver.resolveHandlerMethod(request);

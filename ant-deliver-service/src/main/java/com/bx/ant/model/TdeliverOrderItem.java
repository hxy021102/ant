...
@DynamicInsert(true)
@DynamicUpdate(true)
public class TdeliverOrderItem implements java.io.Serializable,IEntity{
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "DeliverOrderItem";
	...
	public static final String ALIAS_IN_PRICE = "成本价";
	...
	//columns END
		...
		public TdeliverOrderItem(){
		}
		public TdeliverOrderItem(Long id) {
			this.id = id;
		}
	...
	public boolean equals(Object obj) {
		if(obj instanceof DeliverOrderItem == false) return false;
		if(this == obj) return true;
		DeliverOrderItem other = (DeliverOrderItem)obj;

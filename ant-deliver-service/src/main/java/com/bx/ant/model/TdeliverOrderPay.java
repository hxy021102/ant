...
@Entity
@Table(name = "deliver_order_pay")
@DynamicInsert(true)
@DynamicUpdate(true)
public class TdeliverOrderPay implements java.io.Serializable,IEntity{
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "DeliverOrderPay";
	...
	//columns END
		...
		public TdeliverOrderPay(){
		}
		public TdeliverOrderPay(Long id) {
			this.id = id;
		}
	...
	public boolean equals(Object obj) {
		if(obj instanceof DeliverOrderPay == false) return false;
		if(this == obj) return true;
		DeliverOrderPay other = (DeliverOrderPay)obj;

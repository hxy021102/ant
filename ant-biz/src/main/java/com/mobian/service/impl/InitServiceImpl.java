...
import com.mobian.dao.*;
import com.mobian.model.*;
import com.mobian.service.InitServiceI;
...
public class InitServiceImpl implements InitServiceI {
	...
	private void initBaseType(){
		Tbasetype baseType = new Tbasetype();
		baseType.setCode("SV");
		baseType.setName("系统环境变量");
		baseType.setType(0);
		basetypeDao.saveOrUpdate(baseType);
		
		Tbasedata bd = new Tbasedata();
		bd.setBaseType(baseType);
		bd.setId("SV001");
		bd.setName("Jbase平台");
		bd.setDescription("系统title");
		bd.setSeq(1);
		basedataDao.saveOrUpdate(bd);
		
		bd = new Tbasedata();
		bd.setBaseType(baseType);
		bd.setId("SV002");
		bd.setName("版权所有@John");
		bd.setDescription("版权所有");
		bd.setSeq(2);
		basedataDao.saveOrUpdate(bd);
		...
		bd.setBaseType(baseType);
		bd.setId("SV003");
		bd.setName("欢迎使用Jbase平台");
		bd.setDescription("welcome");
		bd.setSeq(3);
		basedataDao.saveOrUpdate(bd);
		...
		bd.setId("SV004");
		bd.setName("2");
		bd.setDescription("0：开发，1：测试，2：生产");
		bd.setSeq(4);
		basedataDao.saveOrUpdate(bd);
		
		
		
		Tbasetype ex = new Tbasetype();
		ex.setCode("EX");
		ex.setName("异常");
		ex.setType(0);
		basetypeDao.saveOrUpdate(ex);
		
		Tbasedata ex01 = new Tbasedata();
		ex01.setBaseType(ex);
		ex01.setId("EX0001");
		ex01.setName("系统繁忙！");
		ex01.setDescription("全局系统异常提示");
		ex01.setSeq(1);	
		basedataDao.saveOrUpdate(ex01);
	}
	...
	private void initResource() {
		...
		Tresource autoDev = new Tresource();
		autoDev.setId("autoDev");
		autoDev.setName("自动化开发");
		autoDev.setTresourcetype(menuType);
		autoDev.setTresource(xtgl);
		autoDev.setSeq(4);
		autoDev.setUrl("/autoController/manager");
		autoDev.setIcon("cog");
		resourceDao.saveOrUpdate(autoDev);

		Tresource autoAdd = new Tresource();
		autoAdd.setId("autoAdd");
		autoAdd.setName("生成资源权限");
		autoAdd.setTresourcetype(funType);
		autoAdd.setTresource(autoDev);
		autoAdd.setSeq(1);
		autoAdd.setUrl("/autoController/add");		
		resourceDao.saveOrUpdate(autoAdd);
		
		
		Tresource bdgl = new Tresource();
		bdgl.setId("bdgl");
		bdgl.setName("数据字典");
		bdgl.setTresourcetype(menuType);
		bdgl.setTresource(xtgl);
		bdgl.setSeq(4);
		bdgl.setUrl("/basedataController/manager");
		bdgl.setIcon("database");
		resourceDao.saveOrUpdate(bdgl);

		Tresource bdglDateGrid = new Tresource();
		bdglDateGrid.setId("bdglDateGrid");
		bdglDateGrid.setName("基础数据表格");
		bdglDateGrid.setTresourcetype(funType);
		bdglDateGrid.setTresource(bdgl);
		bdglDateGrid.setSeq(1);
		bdglDateGrid.setUrl("/basedataController/basedataDataGrid");		
		resourceDao.saveOrUpdate(bdglDateGrid);

		Tresource bdglAddPage = new Tresource();
		bdglAddPage.setId("bdglAddPage");
		bdglAddPage.setName("添加基础数据页面");
		bdglAddPage.setTresourcetype(funType);
		bdglAddPage.setTresource(bdgl);
		bdglAddPage.setSeq(2);
		bdglAddPage.setUrl("/basedataController/basedataAddPage");		
		resourceDao.saveOrUpdate(bdglAddPage);

		Tresource bdglAdd = new Tresource();
		bdglAdd.setId("bdglAdd");
		bdglAdd.setName("添加基础数据");
		bdglAdd.setTresourcetype(funType);
		bdglAdd.setTresource(bdgl);
		bdglAdd.setSeq(3);
		bdglAdd.setUrl("/basedataController/basedataAdd");
		resourceDao.saveOrUpdate(bdglAdd);

		Tresource bdglEditPage = new Tresource();
		bdglEditPage.setId("bdglEditPage");
		bdglEditPage.setName("编辑基础数据页面");
		bdglEditPage.setTresourcetype(funType);
		bdglEditPage.setTresource(bdgl);
		bdglEditPage.setSeq(3);
		bdglEditPage.setUrl("/basedataController/basedataEditPage");
		resourceDao.saveOrUpdate(bdglEditPage);

		Tresource bdglEdit = new Tresource();
		bdglEdit.setId("bdglEdit");
		bdglEdit.setName("编辑基础数据");
		bdglEdit.setTresourcetype(funType);
		bdglEdit.setTresource(bdgl);
		bdglEdit.setSeq(5);
		bdglEdit.setUrl("/basedataController/basedataEdit");
		resourceDao.saveOrUpdate(bdglEdit);

		Tresource bdglDelete = new Tresource();
		bdglDelete.setId("bdglDelete");
		bdglDelete.setName("删除基础数据");
		bdglDelete.setTresourcetype(funType);
		bdglDelete.setTresource(bdgl);
		bdglDelete.setSeq(6);
		bdglDelete.setUrl("/basedataController/basedatadelete");
		resourceDao.saveOrUpdate(bdglDelete);

		Tresource bdtyAdd = new Tresource();
		bdtyAdd.setId("bdtyAdd");
		bdtyAdd.setName("添加基础类型");
		bdtyAdd.setTresourcetype(funType);
		bdtyAdd.setTresource(bdgl);
		bdtyAdd.setSeq(7);
		bdtyAdd.setUrl("/basedataController/basetypeAdd");
		resourceDao.saveOrUpdate(bdtyAdd);
		
		Tresource bdtyEdit = new Tresource();
		bdtyEdit.setId("bdtyEdit");
		bdtyEdit.setName("编辑基础类型");
		bdtyEdit.setTresourcetype(funType);
		bdtyEdit.setTresource(bdgl);
		bdtyEdit.setSeq(15);
		bdtyEdit.setUrl("/basedataController/basetypeEdit");
		resourceDao.saveOrUpdate(bdtyEdit);
		
		Tresource bdtyAddPage = new Tresource();
		bdtyAddPage.setId("bdtyAddPage");
		bdtyAddPage.setName("添加基础类型页面");
		bdtyAddPage.setTresourcetype(funType);
		bdtyAddPage.setTresource(bdgl);
		bdtyAddPage.setSeq(8);
		bdtyAddPage.setUrl("/basedataController/basetypeAddPage");
		resourceDao.saveOrUpdate(bdtyAddPage);
		
		Tresource bdtyDelete = new Tresource();
		bdtyDelete.setId("bdtyDelete");
		bdtyDelete.setName("删除基础类型");
		bdtyDelete.setTresourcetype(funType);
		bdtyDelete.setTresource(bdgl);
		bdtyDelete.setSeq(10);
		bdtyDelete.setUrl("/basedataController/basetypedelete");
		resourceDao.saveOrUpdate(bdtyDelete);				
		
		Tresource bdtyTree = new Tresource();
		bdtyTree.setId("bdtyTree");
		bdtyTree.setName("基础类型树");
		bdtyTree.setTresourcetype(funType);
		bdtyTree.setTresource(bdgl);
		bdtyTree.setSeq(20);
		bdtyTree.setUrl("/basedataController/treeGrid");
		resourceDao.saveOrUpdate(bdtyTree);

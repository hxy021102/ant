...
var statusIcon = {
    ...
    OD12 : "../images/order_status_10.png",
    OD15 : "../images/order_status_10.png",
    OD20 : "../images/order_status_20.png",
    OD30 : "../images/order_status_30.png",
    OD35 : "../images/order_status_30.png",
    OD40 : "../images/order_status_30.png",
    OD31 : "../images/order_status_31.png"
};
$(function () {
    CAMEL_ORDER.init();
});
...
var CAMEL_ORDER = {
    ...
    _getOrderList : function() {
        ...
        if(tabIndex == 0)
            ...
            params.status = 'OD10,OD05,OD12,OD15'; // 待发货
        else if(tabIndex == 2)
            params.status = 'OD20'; // 待收货
        else if(tabIndex == 3)
            params.status = 'OD30,OD31,OD35,OD40'; // 已完成

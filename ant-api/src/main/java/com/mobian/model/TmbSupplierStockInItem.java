...
public class TmbSupplierStockInItem implements java.io.Serializable,IEntity{
	...
	//alias
	public static final String TABLE_ALIAS = "MbSupplierStockInItem";
	...
	//columns END
		...
		public TmbSupplierStockInItem(){
		}
		public TmbSupplierStockInItem(Integer id) {
			this.id = id;
		}
	...
	public boolean equals(Object obj) {
		if(obj instanceof MbSupplierStockInItem == false) return false;
		if(this == obj) return true;
		MbSupplierStockInItem other = (MbSupplierStockInItem)obj;

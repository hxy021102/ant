...
@Entity
@Table(name = "mb_shopping")
@DynamicInsert(true)
@DynamicUpdate(true)
public class TmbShopping implements java.io.Serializable,IEntity{
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "MbShopping";
	...
	public boolean equals(Object obj) {
		if(obj instanceof MbShopping == false) return false;
		if(this == obj) return true;
		MbShopping other = (MbShopping)obj;

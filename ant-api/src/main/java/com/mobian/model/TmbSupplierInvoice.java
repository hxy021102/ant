...
@Entity
@Table(name = "mb_supplier_invoice")
@DynamicInsert(true)
@DynamicUpdate(true)
public class TmbSupplierInvoice implements java.io.Serializable,IEntity{
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "MbSupplierInvoice";
	...
	public static final String ALIAS_INVOICE_DEFAULT = "默认模板";
	...
	//columns END
		...
		public TmbSupplierInvoice(){
		}
		public TmbSupplierInvoice(Integer id) {
			this.id = id;
		}
	...
	@Column(name = "invoice_use", unique = false, nullable = true, insertable = true, updatable = true, length = 10)
	...
	@Column(name = "invoice_type", unique = false, nullable = true, insertable = true, updatable = true, length = 10)
	...
	@Column(name = "invoice_default", unique = false, nullable = true, insertable = true, updatable = true, length = 0)
	...
	public String toString() {
		return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
			...
			.append("InvoiceDefault",getInvoiceDefault())
			.toString();
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof MbSupplierInvoice == false) return false;
		if(this == obj) return true;
		MbSupplierInvoice other = (MbSupplierInvoice)obj;

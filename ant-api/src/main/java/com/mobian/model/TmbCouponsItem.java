...
@Entity
@Table(name = "mb_coupons_item")
@DynamicInsert(true)
@DynamicUpdate(true)
public class TmbCouponsItem implements java.io.Serializable,IEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "MbCouponsItem";
	...
	//columns END
		...
		public TmbCouponsItem(){
		}
		public TmbCouponsItem(Integer id) {
			this.id = id;
		}
	...
	public boolean equals(Object obj) {
		if(obj instanceof MbCouponsItem == false) return false;
		if(this == obj) return true;
		MbCouponsItem other = (MbCouponsItem)obj;

...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
            url : '${pageContext.request.contextPath}/mbRechargeLogController/addAccessSupplierMoney',
			onSubmit : function() {
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">	
		<form id="form" method="post">		
			<input  name="accessSupplierId" type="hidden" value="${param.accessSupplierId}"  />
			<table class="table table-hover table-condensed">
				<tr>
					...
					<th>充值类型</th>
					<td colspan="3">
						<jb:selectSql dataType="SQ021" name="refType" required="true"></jb:selectSql>
					</td>
				</tr>
				<tr>
					<th>备注</th>

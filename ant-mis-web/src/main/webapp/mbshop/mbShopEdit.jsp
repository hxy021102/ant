...
<script type="text/javascript">
	$(function() {
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/mbShopController/edit',
			onSubmit : function() {
		...
		<form id="form" method="post">
			...
			<table class="table table-hover table-condensed">
				<tr>
					...
					<td>
						<input name="name" type="text" class="easyui-validatebox span2" data-options="required:true" value="${mbShop.name}"/>
					</td>
				...
				<tr>
					...
					<td colspan="3">
						<jb:select dataType="ST" name="shopType" mustSelect="true" required="true" value="${mbShop.shopType}"></jb:select>
					</td>
				...
				<tr>
					...
					<td>
						<input class="span2 easyui-validatebox" name="contactPeople" data-options="required:true" type="text" value="${mbShop.contactPeople}"/>
					</td>
					<th><%=TmbShop.ALIAS_CONTACT_PHONE%>
					</th>
					<td>
						<input class="span2 easyui-validatebox" name="contactPhone" data-options="required:true" type="text" value="${mbShop.contactPhone}"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="3">
						...
						<input class="easyui-validatebox span2" style="width: 80%" data-options="required:true" name="address" id="address" type="text" value="${mbShop.address}"/>

		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				<tr>	
					...
					<td>
					<input class="span2" name="addtime" type="text" onclick="WdatePicker({dateFmt:'<%=TmbOrderCallbackItem.FORMAT_ADDTIME%>'})"  maxlength="0" class="required " />
					</td>							
				</tr>	
				<tr>	
					<th><%=TmbOrderCallbackItem.ALIAS_UPDATETIME%></th>	
					<td>
					<input class="span2" name="updatetime" type="text" onclick="WdatePicker({dateFmt:'<%=TmbOrderCallbackItem.FORMAT_UPDATETIME%>'})"  maxlength="0" class="required " />
					</td>							
				...
				<tr>
					<th><%=TmbOrderCallbackItem.ALIAS_LOGIN_NAME%></th>
					<td>

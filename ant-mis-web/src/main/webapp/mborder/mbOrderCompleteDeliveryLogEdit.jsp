...
<script type="text/javascript">
	$(function() {
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/mbOrderLogController/addCompleteDeliveryRemarkLog',
			onSubmit : function() {
		...
		<form id="form" method="post">
			...
			<table class="table table-hover table-condensed">
				<tr>
					...
					<td>
						<textarea  name="completeDeliveryRemark" class ="easyui-validatebox" data-options="required:true" style="width: 90%"></textarea>
					</td>
				</tr>
			</table>
		</form>

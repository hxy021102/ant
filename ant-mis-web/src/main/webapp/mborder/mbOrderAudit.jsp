...
<script type="text/javascript">
	$(function() {
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/mbOrderController/editAudit',
			onSubmit : function() {
	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		<form id="form" method="post">
			...
			<table class="table table-hover table-condensed">
				<tr>
					<th><%=TmbPaymentItem.ALIAS_PAY_CODE%></th>
					<th>
				...
				<tr>
					...
					<td>
						<textarea  name="remark" class ="easyui-validatebox" data-options="required:true" style="width: 91%"></textarea>
					</td>
				</tr>
			</table>
		</form>

...
<ul>
	...
	<li>20130531修复Oracle数据库中，用户图表报错的BUG，原因是创建时间是java.util.Date类型，在使用[HOUR]函数的时候，报错信息[ORA-30076:
		对析出来源无效的析出字段]</li>
	...
	<li>20130520增加jetty插件(mvn
		jetty:run可以启动项目，可以用http://127.0.0.1:8080/sypro/index.jsp访问)</li>

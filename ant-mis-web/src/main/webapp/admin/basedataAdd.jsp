...
<script type="text/javascript">
	$(function() {
		$('#form').form({
			url : '${pageContext.request.contextPath}/basedataController/basedataAdd',
			onSubmit : function() {			
	...
	<div data-options="region:'center',border:false" title=""
		...
		<form id="form" method="post" enctype="multipart/form-data">
			<table class="table table-hover table-condensed">
				...
				<tr>
					<th>上级编码</th>
					<td><input name="pid" type="text" class="span2" maxlength="32"></td>
					<th>排序</th>
					<td><input name="seq" value="10" class="easyui-numberspinner"
				...
				<tr>
					...
					<td colspan="3"><textarea name="description" id="description"
							cols="50" rows="4" style="width: 90%"></textarea></td>
				</tr>
			</table>
		</form>
	</div>

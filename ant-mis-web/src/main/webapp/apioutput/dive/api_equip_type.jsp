...
<%
String url = request.getContextPath()+"/api/apiEquipController/typelist";
%>
...
<body>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="equip_type_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td align="right" style="width: 180px;"><label>equipType(设备类型*)：</label></td>
						<td><input name="equipType" type="text" class="span2" value="ET01" /></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#equip_type_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：装备类型结果集，查看基础数据接口</label>
			<div id="equip_type_result"></div>
			<div>

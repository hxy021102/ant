...
<%
String url = request.getContextPath()+"/api/apiAddressController/arealist";
%>
...
<body>
	...
	$(function() {
		...
		$('#address_area_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#address_area_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="address_area_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#address_area_Form').submit();" /></td>
					</tr>
				</table>
			</form>

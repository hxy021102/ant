...
<%
String url = request.getContextPath()+"/api/apiActivityController/apply";
%>
...
<body>
	...
	$(function() {
		...
		$('#activity_apply_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#activity_apply_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="activity_apply_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#activity_apply_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
			<div id="activity_apply_result"></div>
			<div>

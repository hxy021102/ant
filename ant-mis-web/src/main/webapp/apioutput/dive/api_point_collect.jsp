...
<%
String url = request.getContextPath()+"/api/apiPointController/addCollect";
%>
...
<body>
	...
	$(function() {
		...
		$('#point_collect_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#point_collect_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="point_collect_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#point_collect_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
			<div id="point_collect_result"></div>
			<div>

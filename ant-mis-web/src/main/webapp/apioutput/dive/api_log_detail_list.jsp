...
<%
String url = request.getContextPath()+"/api/apiLogController/logDetailList";
%>
...
<body>
	...
	$(function() {
		...
		$('#dive_log_detail_list_Form').form({
			url : '<%=url%>',
			onSubmit : function() {
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#dive_log_detail_list_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="dive_log_detail_list_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td align="right" style="width: 180px;"><label>logId(日志ID)：</label></td>
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#dive_log_detail_list_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：潜记明细结果集，查看基础数据接口</label>
			<div id="dive_log_detail_list_result"></div>
			<div>

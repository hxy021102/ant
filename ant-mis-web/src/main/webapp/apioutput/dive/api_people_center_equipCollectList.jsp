...
<%
String url = request.getContextPath()+"/api/apiEquipController/collectlist";
%>
...
<body>
	...
	$(function() {
		...
		$('#equip_collect_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#equip_collect_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="equip_collect_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#equip_collect_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
			<div id="equip_collect_result"></div>
			<div>

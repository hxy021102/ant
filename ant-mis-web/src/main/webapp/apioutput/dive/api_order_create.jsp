...
<%
String url = request.getContextPath()+"/api/apiOrderController/createOrder";
%>
...
<body>
	...
	$(function() {
		...
		$('#order_create_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#order_create_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="order_create_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td align="right" style="width: 180px;"><label>cardIds(购物车id集合)：</label></td>
						<td><input name="cardIds" type="text" class="span2" value="" />（格式：id1,id2,id3...）</td>
					</tr>

					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#order_create_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
			<div id="order_create_result"></div>
			<div>

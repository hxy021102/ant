...
<%
String url = request.getContextPath()+"/api/apiEquipController/search";
%>
...
<body>
	...
	$(function() {
		...
		$('#equip_search_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#equip_search_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="equip_search_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td align="right" style="width: 180px;"><label>equipName(搜索值)：</label></td>
						<td><input name="equipName" type="text" class="span2" value="" />（按名称模糊查询）</td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#equip_search_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
			<div id="equip_search_result"></div>
			<div>

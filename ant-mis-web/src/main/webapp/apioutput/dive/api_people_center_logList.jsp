...
<%
String url = request.getContextPath()+"/api/apiLogController/loglist";
%>
				...
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#dive_log_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：潜水日志结果集，查看基础数据接口</label>
			<div id="dive_log_result"></div>
			<div>

...
<%
String url = request.getContextPath()+"/api/apiAddressController/search";
%>
...
<body>
	...
	$(function() {
		...
		$('#address_search_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#address_search_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="address_search_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#address_search_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：潜点特征结果集，查看基础数据接口</label>
			<div id="address_search_result"></div>
			<div>

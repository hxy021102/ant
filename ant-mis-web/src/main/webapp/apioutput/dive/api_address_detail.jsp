...
<%
String url = request.getContextPath()+"/api/apiAddressController/getAddressDetail";
%>
...
<body>
	...
	$(function() {
		...
		$('#address_detail_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#address_detail_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="address_detail_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#address_detail_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
			<div id="address_detail_result"></div>
			<div>

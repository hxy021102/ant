...
<%
String url = request.getContextPath()+"/api/apiCourseController/getCourseDetail";
%>
...
<body>
	...
	$(function() {
		...
		$('#course_detail_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#course_detail_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="course_detail_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#course_detail_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
			<div id="course_detail_result"></div>
			<div>

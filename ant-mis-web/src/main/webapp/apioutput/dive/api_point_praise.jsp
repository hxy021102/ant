...
<%
String url = request.getContextPath()+"/api/apiPointController/addPraise";
%>
...
<body>
	...
	$(function() {
		...
		$('#point_praise_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#point_praise_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="point_praise_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#point_praise_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
			<div id="point_praise_result"></div>
			<div>

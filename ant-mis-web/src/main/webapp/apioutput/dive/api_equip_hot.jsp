...
<%
String url = request.getContextPath()+"/api/apiEquipController/hotlist";
%>
				...
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#equip_hot_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
			<div id="equip_hot_result"></div>
			<div>

...
<%
String url = request.getContextPath()+"/api/apiAddressController/collectlist";
%>
...
<body>
	...
	$(function() {
		...
		$('#address_collect_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#address_collect_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="address_collect_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#address_collect_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：个人中心潜点收藏结果集，查看基础数据接口</label>
			<div id="address_collect_result"></div>
			<div>

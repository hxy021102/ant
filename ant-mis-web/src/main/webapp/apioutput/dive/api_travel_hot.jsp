...
<%
String url = request.getContextPath()+"/api/apiTravelController/travel_hot";
%>
...
<body>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="travel_hot_Form" action="" method="post">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#travel_hot_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：船宿列表结果集，查看基础数据接口</label>
			<div id="travel_hot_result"></div>
			<div>

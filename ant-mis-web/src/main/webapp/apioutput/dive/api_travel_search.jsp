...
<%
String url = request.getContextPath()+"/api/apiTravelController/search";
%>
	...
	$(function() {
		...
		$('#travel_search_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#travel_search_result").text(result);
			}
		});
	});
</script>
				...
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#travel_search_Form').submit();" /></td>
					</tr>
				</table>
			</form>

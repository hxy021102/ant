...
<%
String url = request.getContextPath()+"/api/apiActivityController/addComment";
%>
...
<body>
	...
	$(function() {
		...
		$('#activity_add_comment_Form').form({
			url : '<%=url%>',
			onSubmit : function() {
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#activity_add_comment_result").text(result);
			}
		});
	});
</script>
				...
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#activity_add_comment_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
			<div id="activity_add_comment_result"></div>
			<div>

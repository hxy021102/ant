...
<%
String url = request.getContextPath()+"/api/apiActivityController/unapply";
%>
...
<body>
	...
	$(function() {
		...
		$('#activity_unapply_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#activity_unapply_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="activity_unapply_Form" action="">
			...
			<label>结果：</label>
			<div id="activity_unapply_result"></div>
			<div>

...
<%
String url = request.getContextPath()+"/api/apiOrderController/cancelOrder";
%>
...
<body>
	...
	$(function() {
		...
		$('#order_cancel_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#order_cancel_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="order_cancel_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#order_cancel_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
			<div id="order_cancel_result"></div>
			<div>

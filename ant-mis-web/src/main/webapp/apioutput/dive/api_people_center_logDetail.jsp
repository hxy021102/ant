...
<%
String url = request.getContextPath()+"/api/apiLogController/logDetail";
%>
...
<body>
	...
	$(function() {
		...
		$('#dive_log_detail_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#dive_log_detail_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="dive_log_detail_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#dive_log_detail_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：潜水日志详情，查看基础数据接口</label>
			<div id="dive_log_detail_result"></div>
			<div>

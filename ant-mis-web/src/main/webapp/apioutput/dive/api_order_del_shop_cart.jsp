...
<%
String url = request.getContextPath()+"/api/apiOrderController/delShopCart";
%>
...
<body>
	...
	$(function() {
		...
		$('#del_shop_cart_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#del_shop_cart_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="del_shop_cart_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#del_shop_cart_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
			<div id="del_shop_cart_result"></div>
			<div>

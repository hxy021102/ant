...
<%
String url = request.getContextPath()+"/api/apiTravelController/collectlist";
%>
...
<body>
	...
	$(function() {
		...
		$('#travel_collect_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#travel_collect_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="travel_collect_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#travel_collect_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：个人中心潜水旅游收藏结果集，查看基础数据接口</label>
			<div id="travel_collect_result"></div>
			<div>

...
<%
String url = request.getContextPath()+"/api/apiLogController/addComment";
%>
...
<body>
	...
	$(function() {
		...
		$('#log_add_comment_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#log_add_comment_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="log_add_comment_Form" action="" method="post">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#log_add_comment_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
			<div id="log_add_comment_result"></div>
			<div>

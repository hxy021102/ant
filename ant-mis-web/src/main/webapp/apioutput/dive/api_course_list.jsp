...
<%
String url = request.getContextPath()+"/api/apiCourseController/courselist";
%>
...
<body>
	...
	$(function() {
		...
		$('#course_list_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#course_list_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="course_list_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#course_list_Form').submit();" /></td>
					</tr>
				</table>
			</form>

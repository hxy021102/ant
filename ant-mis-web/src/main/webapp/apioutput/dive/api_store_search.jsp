...
<%
String url = request.getContextPath()+"/api/apiStoreController/search";
%>
...
<body>
	...
	$(function() {
		...
		$('#store_search_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#store_search_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="store_search_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#store_search_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：度假村列表结果集，查看基础数据接口</label>
			<div id="store_search_result"></div>
			<div>

		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				<tr>	
					...
					<td>
					<input class="span2" name="addtime" type="text" onclick="WdatePicker({dateFmt:'<%=TdeliverOrder.FORMAT_ADDTIME%>'})"  maxlength="0" class="required " />
					</td>							
				</tr>	
				<tr>	
					<th><%=TdeliverOrder.ALIAS_UPDATETIME%></th>	
					<td>
					<input class="span2" name="updatetime" type="text" onclick="WdatePicker({dateFmt:'<%=TdeliverOrder.FORMAT_UPDATETIME%>'})"  maxlength="0" class="required " />
					</td>							
				...
				<tr>	
					...
					<td>
											<input class="span2" name="supplierId" type="text"/>
					</td>							
				...
				<tr>	
					...
					<td>
					<input class="span2" name="deliveryRequireTime" type="text" onclick="WdatePicker({dateFmt:'<%=TdeliverOrder.FORMAT_DELIVERY_REQUIRE_TIME%>'})"  maxlength="0" class="" />
					</td>							
				...
				<tr>	
					...
					<td>
											<jb:select dataType="DPS" name="payStatus"></jb:select>	
					</td>							
				</tr>	
				<tr>	

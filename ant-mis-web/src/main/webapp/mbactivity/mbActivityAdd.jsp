...
<script type="text/javascript">
    $(function () {
        ...
        $('#form').form({
            url: '${pageContext.request.contextPath}/mbActivityController/add',
            onSubmit: function () {
            ...
            success: function (result) {
                ...
                if (result.success) {
                    parent.$.modalDialog.openner_activityDataGrid.datagrid('reload');//之所以能在这里调用到parent.$.modalDialog.openner_dataGrid这个对象，是因为user.jsp页面预定义好了
        ...
        <form id="form" method="post">
            ...
            <table class="table table-hover table-condensed">
                <tr>
                    ...
                    <th style="width: 50px;"><%=TmbActivity.ALIAS_VALID%>
                    </th>
                    <td>
                ...
                <tr>
                    ...
                    <th style="width: 50px;"><%=TmbActivity.ALIAS_EXPIRY_DATE_END%>
                    </th>
                    <td>
                ...
                <tr>
                    <th style="width: 50px;"><%=TmbActivity.ALIAS_REMARK%>
                    </th>
                    <td colspan="3">

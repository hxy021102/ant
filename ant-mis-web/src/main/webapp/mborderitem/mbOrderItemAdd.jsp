...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/mbOrderItemController/add',
			onSubmit : function() {
		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				...
				<tr>	
					...
					<td>
						<input class="span2" name="marketPrice" type="hidden" value="0"/>
					</td>							
					<th><%=TmbOrderItem.ALIAS_BUY_PRICE%></th>	
					<td>
						<input class="span2" name="buyPrice" type="hidden" value="0"/>
					</td>							
				</tr>	
				<tr>	

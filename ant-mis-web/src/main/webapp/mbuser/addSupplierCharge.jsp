...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
            url : '${pageContext.request.contextPath}/mbRechargeLogController/addSupplierCharge',
			onSubmit : function() {
		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				<tr>
					<th>供应商</th>
					<td>
						<input  name="mbSupplierName" type="text"   class="easyui-validatebox span2 " value="${mbSupplier.name}"  readonly/>
					</td>

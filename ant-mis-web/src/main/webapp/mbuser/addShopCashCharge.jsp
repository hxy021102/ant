...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
            url : '${pageContext.request.contextPath}/mbRechargeLogController/addCashCharge',
			onSubmit : function() {
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">	
		<form id="form" method="post">		
			...
			<input type="hidden"  name="refType" value="BT012"/>
			<table class="table table-hover table-condensed">
				<tr>
					<th>门店ID</th>
					<td>
						<input  name="shopId" type="text"   class="easyui-validatebox span2 " value="${param.shopId}"  readonly/>
					</td>

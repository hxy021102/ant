...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
            url : '${pageContext.request.contextPath}/mbRechargeLogController/addDeliverShopMoney',
			onSubmit : function() {
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">	
		<form id="form" method="post">		
			<input  name="shopId" type="hidden" value="${mbShop.id}"  />
			<table class="table table-hover table-condensed">
				<tr>
					<th>门店名称</th>
					<td>
						<input  name="shopName" type="text"   class="easyui-validatebox span2 " value="${mbShop.name}"  readonly/>
					</td>

...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/mbSupplierContractItemController/add',
			onSubmit : function() {
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">	
		<form id="form" method="post">		
			    ...
			    <input type="hidden" name="supplierContractId" value="${supplierContractId}"/>
			<table class="table table-hover table-condensed">
					<tr>
					    ...
					    <td>
						   <input   name="priceStr" type="text"  class="span2 easyui-validatebox money_input" data-options="required:true"/>

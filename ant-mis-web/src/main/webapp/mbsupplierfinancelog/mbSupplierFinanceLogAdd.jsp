...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/mbSupplierFinanceLogController/add',
			onSubmit : function() {
		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				<tr>	
					...
					<td>
					<input class="span2" name="addtime" type="text" onclick="WdatePicker({dateFmt:'<%=TmbSupplierFinanceLog.FORMAT_ADDTIME%>'})"  maxlength="0" class="required " />
					</td>							
				</tr>	
				<tr>	
					<th><%=TmbSupplierFinanceLog.ALIAS_UPDATETIME%></th>	
					<td>
					<input class="span2" name="updatetime" type="text" onclick="WdatePicker({dateFmt:'<%=TmbSupplierFinanceLog.FORMAT_UPDATETIME%>'})"  maxlength="0" class="required " />
					</td>							
				...
				<tr>	
					...
					<td>
											<input class="span2" name="supplierStockInId" type="text"/>
					</td>							
					<th><%=TmbSupplierFinanceLog.ALIAS_PAY_LOGIN_ID%></th>	
					<td>
											<input class="span2" name="payLoginId" type="text"/>
					</td>							
				</tr>	
				<tr>	
				...
				<tr>	
					...
					<td>
											<input class="span2" name="invoiceLoginId" type="text"/>
					</td>							
					<th><%=TmbSupplierFinanceLog.ALIAS_PAY_REMARK%></th>	
					<td>
											<input class="span2" name="payRemark" type="text"/>
					</td>							
				</tr>	
				<tr>	
					<th><%=TmbSupplierFinanceLog.ALIAS_INVOICE_REMARK%></th>	
					<td>
											<input class="span2" name="invoiceRemark" type="text"/>
					</td>							
				</tr>	
			</table>		
		</form>

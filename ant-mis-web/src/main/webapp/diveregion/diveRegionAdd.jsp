...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/diveRegionController/add',
			onSubmit : function() {
		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				<tr>	
					...
					<td>
											<input class="span2" name="regionLevel" type="text"/>
					</td>							
					<th><%=TdiveRegion.ALIAS_REGION_NAME_ZH%></th>	
					<td>
											<input class="span2" name="regionNameZh" type="text"/>
					</td>							
				</tr>	
				<tr>	
					<th><%=TdiveRegion.ALIAS_REGION_NAME_EN%></th>	
					<td>
											<input class="span2" name="regionNameEn" type="text"/>
					</td>							
					<th><%=TdiveRegion.ALIAS_REGION_PARENT_ID%></th>	
					<td>
											<input class="span2" name="regionParentId" type="text"/>
					</td>							
				</tr>	
				<tr>	
